...
typedef struct _CarServer_Response {
    ...
    union {
        CarServer_VehicleData getVehicleData;
...
#define CarServer_GetVehicleData_init_default    {false, CarServer_GetDriveState_init_default}
...
#define CarServer_GetVehicleData_init_zero       {false, CarServer_GetDriveState_init_zero}
...
#define CarServer_Response_getVehicleData_tag    2
...
X(a, STATIC,   ONEOF,    MESSAGE,  (response_msg,getVehicleData,response_msg.getVehicleData),   2) \
...
#define CarServer_Response_response_msg_getVehicleData_MSGTYPE CarServer_VehicleData
...
#define CarServer_GetVehicleData_size            2
