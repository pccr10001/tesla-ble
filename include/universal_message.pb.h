...
typedef enum _UniversalMessage_MessageFault_E {
    ...
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_BUSY = 1,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_TIMEOUT = 2,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_UNKNOWN_KEY_ID = 3,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INACTIVE_KEY = 4,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INVALID_SIGNATURE = 5,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INVALID_TOKEN_OR_COUNTER = 6,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INSUFFICIENT_PRIVILEGES = 7,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INVALID_DOMAINS = 8,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INVALID_COMMAND = 9,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_DECODING = 10,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INTERNAL = 11,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_WRONG_PERSONALIZATION = 12,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_BAD_PARAMETER = 13,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_KEYCHAIN_IS_FULL = 14,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INCORRECT_EPOCH = 15,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_IV_INCORRECT_LENGTH = 16,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_TIME_EXPIRED = 17,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_NOT_PROVISIONED_WITH_IDENTITY = 18,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_COULD_NOT_HASH_METADATA = 19,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_TIME_TO_LIVE_TOO_LONG = 20,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_REMOTE_ACCESS_DISABLED = 21,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_REMOTE_SERVICE_ACCESS_DISABLED = 22,
    UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_COMMAND_REQUIRES_ACCOUNT_CREDENTIALS = 23
...
X(a, STATIC,   ONEOF,    ENUM,     (sub_destination,domain,sub_destination.domain),   1) \
